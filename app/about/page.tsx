        ...
        <div className="site-container" style={{ padding: '0 clamp(20px, 5vw, 80px)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'clamp(32px, 5vw, 60px)' }}>
            {[
              ...
              <div key={item.label} className="bracket-card" style={{ padding: '32px', background: 'rgba(13,27,94,0.04)', border: '1px solid rgba(13,27,94,0.08)', borderRadius: '6px' }}>
        ...
        <div className="site-container" style={{ padding: '0 clamp(20px, 5vw, 80px)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginTop: '40px' }}>
            {Object.values(COMPANY.offices).map(office => (
              <div key={office.city} className="bracket-card" style={{ padding: '32px', background: 'rgba(13,27,94,0.04)', border: '1px solid rgba(13,27,94,0.08)', borderRadius: '6px' }}>
    ...
    <svg viewBox="0 0 320 260" style={{ width: '100%', maxWidth: '320px', opacity: 0.8 }} fill="none">
      ...
      {[
        ...
        <g key={i}>
          ...
          <text x="76" y={m.y - 6} fontSize="12" fill="rgba(10,18,64,0.8)" fontFamily="DM Sans" fontWeight="500">{m.label}</text>
          <text x="76" y={m.y + 10} fontSize="10" fill="rgba(10,18,64,0.4)" fontFamily="DM Sans">{m.sub}</text>
        </g>
      ))}
    </svg>
  );
