            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
              {PILLARS.map((pillar, i) => (
                <div key={pillar.title} className="bracket-card"
                  style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: '6px', padding: '28px', transition: 'border-color 0.3s, transform 0.3s' }}
                >
        ...
        <section style={{ padding: 'clamp(48px, 6vh, 72px) 0' }}>
          <div className="site-container" style={{ padding: '0 clamp(20px, 5vw, 80px)' }}>
            <blockquote style={{
              ...
              background: 'var(--card-bg)', borderRadius: '4px',
        ...
        <section style={{ padding: 'clamp(60px, 8vh, 100px) 0' }}>
          <div className="site-container" style={{ padding: '0 clamp(20px, 5vw, 80px)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
              {PRINCIPLES.map(p => (
                <div key={p.num} style={{ display: 'flex', gap: '16px', padding: '20px', background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: '4px' }}>
